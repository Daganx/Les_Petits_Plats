...
function createIngredientListItem(ingredient) {
  ...
  li.addEventListener("click", () => {
    handleIngredientClick(ingredient, li, closeIcon); // Passer l'icône de fermeture en tant que paramètre
  });
...
function handleIngredientClick(ingredient, li, closeIcon) {
  ...
  if (selectedIngredients.has(ingredient)) {
    ...
    closeIcon.style.display = "none"; // Cacher l'icône de fermeture
  } else {
    addIngredient(ingredient, activeTagsList, li); // Sinon, l'ajouter
    closeIcon.style.display = "inline"; // Afficher l'icône de fermeture
  }
...
function addIngredient(ingredient, activeTagsList, li) {
  ...
  const span = createActiveTag(ingredient, activeTagsList, li); // Passer activeTagsList et li en tant que paramètres
...
function createActiveTag(ingredient, activeTagsList, li) {
  // Ajouter activeTagsList et li en tant que paramètres
